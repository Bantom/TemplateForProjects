        ...
        <ul class="navbar-nav ml-auto" id="nav-menu">
            ...
            <c:choose>
                <c:when test="${param.pageName == 'profile'}">
                    <li class="active nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/admin/profile">Profile</a></li>
                </c:when>
                <c:otherwise>
                    <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/admin/profile">Profile</a></li>
                </c:otherwise>
            </c:choose>
